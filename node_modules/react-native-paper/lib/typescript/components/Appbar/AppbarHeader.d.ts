...
declare const _default: React.ComponentType<Pick<Pick<Partial<import("react-native").ViewProps & React.RefAttributes<View>> & {
    ...
    theme?: import("react-native-paper/node_modules/@callstack/react-theme-provider").$DeepPartial<unknown> | undefined;
}> & import("react-native-paper/node_modules/@callstack/react-theme-provider/typings/hoist-non-react-statics").NonReactStatics<React.ComponentType<Pick<Partial<import("react-native").ViewProps & React.RefAttributes<View>> & {
    dark?: boolean | undefined;
    children: React.ReactNode;
    mode?: "small" | "medium" | "large" | "center-aligned" | undefined;
    elevated?: boolean | undefined;
