...
import Title from 'react-native-paper/lib/typescript/components/Typography/v2/Title';
...
}> & import("react-native-paper/node_modules/@callstack/react-theme-provider/typings/hoist-non-react-statics").NonReactStatics<React.ComponentType<import("react-native").TextProps & {
    children: React.ReactNode;
} & {
    /**
     * Title text for the `DialogTitle`.
